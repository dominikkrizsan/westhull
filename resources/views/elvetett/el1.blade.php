...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div
            class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-600 nav-bgg"
        >
            <div class="main-container">
                <nav
                    class="px-2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 align-middle"
                    id="navbar"
                >
                    <div
                    ...
                    >
                        <a href="#" class="flex items-center">
                            <img
                                src="https://www.townofgypsum.com/home/showpublishedimage/1918/637484690169470000"
        ...
        <footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-600 text-white text-center">footer</footer>
    </body>
</html>
