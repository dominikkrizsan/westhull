    ...
    <div class="min-h-8/12 mt-4 gap-3 max-[1280px]:mx-3 xl:mx-auto xl:w-128">
        ...
        {{-- element 2025--}}
            <div class="container w-full">
                ...
                >
                    <span>2025. évi költségvetés</span>
                </div>
                <div class="content">
                    <ul
                    ...
                    >
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/határozat.pdf'
                                )
                            }}"
                            ><li>határozat</li></a
                        >                   
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/5. napirend.pdf'
                                )
                            }}"
                            ><li>5. napirend</li></a
                        >                   
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/5. napirend 2. melléklet.pdf'
                                )
                            }}"
                        ...
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/5. napirend 1. melléklet.xls'
                                )
                            }}"
                        ...
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/2.modositas/határozat.pdf'
                                )
                            }}"
                            ><li>határozat</li></a
                        >
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/2.modositas/3. napirend.pdf'
                                )
                            }}"
                            ><li>3. napirend</li></a
                        >
                        ...
                        <a
                            ...
                            href="{{
                                asset(
                                    './pdf/tarsulasrol/koltsegvetes/2025/2.modositas/3. napirend 1. melléklet.xls'
                                )
                            }}"
                            ><li>3. napirend 1. melléklet</li></a
                        >
