...
<div class="px-2 py-5 bg-white bg-zinc-200">
    ...
    <div class="grid grid-cols-2 max-[1100px]:grid-cols-1 gap-10 justify-items-center align-center">
        {{-- 2026 --}}
        <div>
            <h1 class="text-2xl font-bold text-zinc-700 mb-3 mt-10 text-center">2026 év</h1>
                ...
                <table id="table" class="max-[1100px]:w-full w-max text-base text-left text-zinc-300 text-zinc-300">
                    ...
                    <tbody>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.07.03</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.07.03.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.06.15</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.06.15.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.06.04</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.06.04.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.05.13</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.05.13.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.04.21</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.04.21.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.03.30</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.03.30.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.02.25</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.02.25.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.02.10</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.02.10.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.01.27</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.01.27.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2026.01.16</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2026/2026.01.16.zip')}}">link</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table id="table" class="max-[1100px]:w-full w-max text-base text-left text-zinc-300 text-zinc-300">
                    ...
                    <tbody>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            ...
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.12.16.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.11.12</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.11.12.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.08.29</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.08.29.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.08.22</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.08.22.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.06.30</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/20250630.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.04.14</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.04.14.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2025.02.25</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2025/2025.02.25.zip')}}">link</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table id="table" class="max-[1100px]:w-full w-max text-base text-left text-zinc-300 text-zinc-300">
                    ...
                    <tbody>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            ...
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2024/2024.12.10.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2024.11.18</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2024/2024.11.18.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2024.10.02</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2024/2024.10.02.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2024.07.03</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2024/2024.07.03.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2024.05.07</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2024/20240507.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                ...
                <table id="table" class="max-[1100px]:w-full w-max text-base text-left text-zinc-300 text-zinc-300">
                    ...
                    <tbody>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            ...
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2023/20231211.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2023.11.21</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2023/20231121.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2023.08.10</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2023/20230810.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                        ...
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            ...
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2023/20230222.zip')}}">link</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table id="table" class="max-[1100px]:w-full w-max text-base text-left text-zinc-300 text-zinc-300">
                    ...
                    <tbody>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            ...
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2022/20221130.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2022.09.27</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2022/20220927.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
                            <td class="px-6 py-4">2022.09.15</td>
                            <td class="px-6 py-4"><a class="text-zinc-300 hover:text-zinc-400 duration-100" href="{{asset('./pdf/tarsulasrol/tarsulasulesek/2022/20220915.zip')}}">link</a></td>
                        </tr>
                        <tr class="bg-white border-b bg-zinc-800 border-gray-700 hover:bg-zinc-700 ease-in duration-100">
