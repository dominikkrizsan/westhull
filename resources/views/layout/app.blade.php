        ...
        >
            ...
            >
                <div class="flex items-center gap-5">
                    ...
                    <a href="" class="text-gray-300 hover:text-emerald-500">
                        <i
                            class="fa-brands fa-twitter fa-lg ease-in duration-200"
                        ></i>
                    </a>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <li>
                            ...
                            <div
                                id="dropdownNavbar"
                                class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-zinc-700 dark:divide-gray-600"
                            >
                                <ul
