...
>
    <head>
        ...
        {{-- favicon --}}
        <link rel="apple-touch-icon" sizes="180x180" href="{{asset('/img/main/apple-touch-icon.png')}}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{asset('/img/main/favicon-32x32.png')}}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{asset('/img/main/favicon-16x16.png')}}">
        <link rel="manifest" href="{{asset('/img/main/site.webmanifest')}}">
        <link rel="mask-icon" href="{{asset('/img/main/safari-pinned-tab.svg')}}" color="#5bbad5">
        <link rel="shortcut icon" href="{{asset('/img/main/favicon.ico')}}">
        <meta name="msapplication-TileColor" content="#da532c">
        <meta name="msapplication-config" content="{{asset('/img/main/browserconfig.xml')}}">
