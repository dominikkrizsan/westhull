...
>
    ...
    <body>
        ...
        <nav
            class="px-2 py-4 bg-white border-gray-200 bg-zinc-800 border-gray-700"
        >
            <div
                class=" main-container flex flex-wrap items-center justify-between mx-auto"
            >
                ...
                >
                    <span
                        class="self-center text-2xl font-medium whitespace-nowrap text-white hover:text-emerald-500 ease-in duration-200"
                        >West</span
                    >
                    <span
                        class="self-center text-2xl font-medium whitespace-nowrap text-emerald-500"
                        >hull</span
                    >
                </a>
                <button
                    ...
                    type="button"
                    class="inline-flex items-center p-2 ml-3 text-lg text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 text-gray-300 hover:bg-gray-700 focus:ring-gray-600"
                ...
                >
                    <ul
                        class="flex flex-col py-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white bg-zinc-800 md:bg-zinc-800 border-gray-700"
                    >
                        <li>
                            <a
                                href="{{ url('/')}}"
                                class="block py-2 pl-3 pr-4 text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 text-gray-300 md:hover:text-zinc-100 hover:bg-gray-700 hover:text-zinc-100 md:hover:bg-transparent ease-in duration-200"
                                >Kezdőlap</a
                            >
                        </li>
                        <li>
                        ...
                        <li>
                            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="flex items-center py-2 pl-3 pr-4 text-lg rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 text-gray-300 md:hover:text-emerald-500 hover:bg-gray-700 hover:text-emerald-500 md:hover:bg-transparent ease-in duration-200" type="button">Társulásról<svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
                            <!-- Dropdown menu -->
        ...
        >
            <div
                class=" main-container flex flex-col gap-4 items-center mx-auto py-16 bg-zinc-800 border-zinc-700"
            >
            ...
            <div class="border-stone-700 border-t border-dotted">
                <div
                    class=" main-container mx-auto pt-6 pb-3 bg-zinc-800 border-zinc-700"
                >
